...
window.Physijs = (function() {
	...
	Physijs.Mesh.prototype.applyTorqueImpulse = function ( force ) {
		if ( this.world ) {
			this.world.execute( 'applyTorqueImpulse', { id: this._physijs.id, impulse_x: force.x, impulse_y: force.y, impulse_z: force.z } );
		}
	};
	...
	Physijs.Mesh.prototype.applyTorque = function ( force ) {
		if ( this.world ) {
			this.world.execute( 'applyTorque', { id: this._physijs.id, force_x: force.x, force_y : force.y, force_z : force.z } );
		}
	};
